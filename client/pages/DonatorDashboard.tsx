      ...
      <div className="khair-container py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {features.map((feature) => (
            <Link
              key={feature.title}
              to={feature.href}
              className="khair-card transition-all hover:shadow-md cursor-pointer hover:border-primary no-underline"
            >
              ...
              <div className="inline-flex items-center gap-2 mt-4 text-primary font-medium group-hover:gap-3 transition-all">
                Get Started
        ...
        <div className="khair-card bg-primary/5 border-primary/20 mt-12">
          <div className="text-center max-w-2xl mx-auto">
            <h3 className="font-semibold text-lg mb-2">Welcome to Wasstet khir</h3>
