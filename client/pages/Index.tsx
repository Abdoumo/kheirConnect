          ...
          {[
            {
              icon: "👑",
              title: "Admin",
              description: "Oversee the platform and manage all institutions",
              features: [
        ...
        <div className="khair-card bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 opacity-90">
              Join KhairConnect today and become part of a community committed to coordinated
              charitable giving.
            </p>
            <Link
              to="/register"
